...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference("Feature.count") do
      post features_url, params: { feature: { about: @feature.about, short_title: @feature.short_title, what_to_expect: @feature.what_to_expect } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { about: @feature.about, short_title: @feature.short_title, what_to_expect: @feature.what_to_expect } }
